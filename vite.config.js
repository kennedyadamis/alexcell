  ...
  build: {
    rollupOptions: {
      input: {
        ...
        'print-os-simple-template': resolve(__dirname, 'print-os-simple-template.html'),
        'print-os-pdf-template': resolve(__dirname, 'print-os-pdf-template.html'),
        'print-os-report-template': resolve(__dirname, 'print-os-report-template.html'),
        'print-cash-flow-template': resolve(__dirname, 'print-cash-flow-template.html'),
        'print-cash-flow-pdf-template': resolve(__dirname, 'print-cash-flow-pdf-template.html'),
